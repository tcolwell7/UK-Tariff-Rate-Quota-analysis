...
saveWorkbook(wb3, file = "..\\outputs\\trq_data_output8.xlsx", overwrite = T)
...
write.xlsx(uk_trqs_filled, "..\\outputs\\uk_trqs_filled8.xlsx", overwrite = T)
...
saveWorkbook(wb2, file = "..\\outputs\\trq_sector_data_output8.xlsx", overwrite = T)
...
write.xlsx(uk_trqs_filled_sector, "..\\outputs\\uk_trqs_filled_sector8.xlsx", overwrite = T)
